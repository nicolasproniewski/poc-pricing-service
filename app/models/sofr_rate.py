...
class SofrRate(Base):
    ...
    __table_args__ = (UniqueConstraint("rate_date", "rate_type", name="uq_sofr_rate_date_type"),)

    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    rate_date: Mapped[date] = mapped_column(Date, nullable=False)
    rate_type: Mapped[str] = mapped_column(String(10), nullable=False, default="overnight")
